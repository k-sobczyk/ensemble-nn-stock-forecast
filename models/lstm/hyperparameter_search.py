...
def run_hyperparameter_search(X_train_scaled, y_train_scaled, X_test_scaled, y_test_scaled,
                              train_company_ids, test_company_ids, num_features, num_companies,
                              device, n_trials=50, timeout=3600):
    ...
    objective_wrapper = lambda trial: objective(
        ...
        train_company_ids, test_company_ids, num_features, num_companies, device
    )
