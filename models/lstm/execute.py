...
from .data_processing import load_and_split_data, prepare_base_data, create_sequences_by_company
...
def run_lstm_model(data_file, date_column='end_of_period', target_column='target', ticker_column='ticker',
                  test_years=[2021, 2022], min_samples_per_company=4, n_trials=1, optuna_timeout=3600):
    ...
    train_ticker_encoded, test_ticker_encoded, num_companies = prepare_base_data(
    ...
    best_params = run_hyperparameter_search(
        ...
        train_ticker_encoded, test_ticker_encoded, num_features, num_companies,
        device, n_trials=n_trials, timeout=optuna_timeout
    )
